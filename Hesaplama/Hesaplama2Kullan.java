...
class Hesaplama2{
	public class Toplama2{				//Dahili üye sınıfı -public 
		public int toplamaYap(int a, int b) {
			return a+b;
		}
	}//class Toplama2
	
	protected class Cikartma2{			//Dahili üye sınıfı -protected 
		public int cikartmaYap(int a, int b) {
			return a-b;
		}
	}//class Cikartma2
	
	class Carpma2{						//Dahili üye sınıfı -friendly 
		public int carpmaYap(int a, int b) {
			return a*b;
		}
	}//class Carpma2
	
	private class Bolme2{				//Dahili üye sınıfı -private 
