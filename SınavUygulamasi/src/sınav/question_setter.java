...
public class question_setter {
    ...
    public static boolean set_questions() {
        ...
        System.out.print("Sınavdaki soru sayısını girin: ");
        int n = s.nextInt();

        ques = n;// değişken sorgular no içerir. Sınav için soru sayısı

        System.out.println("Soruların seçilmesi " + subject_selector.subject + " ...");
        try {
            Thread.sleep(2000);
